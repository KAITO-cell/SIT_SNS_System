...
<html>
	...
	<body bgcolor="f0f0f0">
		...
		<br>
		<br>
		<form action="/SIT_SNS_System/SIT_SNS_system_login" method ="post">
		...
		<br>
		<p style="text-align:center">
		<input type="button" onclick="location.href='/SIT_SNS_System/RegisterStudent'" value="新規登録はこちら" class="button2" method="get">
		</p>
	</body>
</html>
